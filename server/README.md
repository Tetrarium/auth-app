...
- 10.08.2025
  ...
  1. feat(users): Заюзан декоратор пользователя, добавлен ендпоинт me

- 13.08.2025

  1. feat(users): Сделано удаление всех связанных рефреш токенов из базы при удалении пользователя

- TODO: Сделать очистку просроченных рефреш токенов по графику
